"""social_spammer_detection URL Configuration
...
from social_spammer_detection import settings
...
urlpatterns = [
    ...
    url(r'^View_Tweet_Message_Type_Ratio/$', serviceprovider.View_Tweet_Message_Type_Ratio, name="View_Tweet_Message_Type_Ratio"),
